...
import styles from "../pages/About.Style.js";
        ...
        <div style={styles.container}>
            <div style={styles.itemContainer}>
                ...
                <div>
                    ...
                    <span style={styles.nametext}>Ir.H.Ady Setiawan.SH<br/></span>
                    <span style={styles.departmenttext}>President of PDAM Purwa Tirta Dharma</span>
                </div>
            </div>
            <button style={styles.button}><span style={styles.textButton}>Lebih Lengkap</span></button>
        </div>
    );
};
