...
function Footer({ activeMenu, handleClickMenu }) {
    return (
                ...
                <div style={styles.section}>
                    ...
                    >
                        <p style={styles.description}>
                            PDAM Purwa Tirta Dharma Menyediakan air bersih yang
                            sehat yang mampu memberikan kontribusi PAD pada
                            kabupaten Grobogan
                        </p>
                    ...
                    >
                        {MENU.map((item, idx) => (
                            <p
                                href={item.href}
                                key={idx}
                                style={styles.navigasi(activeMenu, idx)}
